...
PATHS = {
    ...
    "notify": '<path d="M8 2.2a3.6 3.6 0 00-3.6 3.6c0 3-1.2 4-1.2 4h9.6s-1.2-1-1.2-4A3.6 3.6 0 008 2.2z"/><path d="M6.7 12.2a1.5 1.5 0 002.6 0"/>',
    ...
    "ask": (
        '<path d="M13.6 9.4a1.6 1.6 0 01-1.6 1.6H6l-3 2.4V4a1.6 1.6 0 011.6-1.6H12A1.6 1.6 0 0113.6 4z"/>'
        '<path d="M6.7 5.9a1.5 1.5 0 012.9.5c0 1-1.5 1.5-1.5 1.5"/><path d="M8.1 9.5h.01"/>'
    ),
    ...
    # 접힌 구역을 여닫는 표시
    # 화면에서 자리를 짚는 노드 — 십자와 가운데 점
    "ai_point": (
        '<path d="M8 1.8v3.4M8 10.8v3.4M1.8 8h3.4M10.8 8h3.4"/>'
        '<circle cx="8" cy="8" r="2.6"/>'
    ),
    # 화면에 손을 대는 노드 — 커서와 톡톡
    "ai_act": (
        '<path d="M4.4 2.6l7.2 4.9-3 .9-.9 3z"/>'
        '<path d="M9.6 10.2l3.4 3.4"/><path d="M2.4 8.6H1M3.6 5.2l-1-1"/>'
    ),
    "caret_right": '<path d="M6.2 3.8L10.4 8l-4.2 4.2"/>',
    "caret_down": '<path d="M3.8 6.2L8 10.4l4.2-4.2"/>',
    "tidy": (
